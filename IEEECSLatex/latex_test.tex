...
\author{Wan Nor Azura bt. Kamarudin\\Fakulti Teknologi Sains Maklumat\\Universiti Kebangsaan Malaysia
\\Email: azurawn@yahoo.com\\P47925 (Matrix No.)}
%\and
...
%\begin{figure}[!t]
%\centering
%\includegraphics[width=0.5in]{logoukm}
% wher%e an .eps filename suffix will be assumed under latex, 
